# 「주택도시기금법」 LLM 판단용 자료 — 시행령 전문 (2/3)

> **분할 안내** — 이 문서는 거대 법령을 LLM 컨텍스트 한계에 맞게 분할한 2번째 파트입니다.
